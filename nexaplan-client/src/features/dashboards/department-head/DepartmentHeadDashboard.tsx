        ...
        <div className="flex gap-1">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-sm font-semibold transition-all ${
              activeModule === 'overview' ? 'bg-[#4F46E5] text-white' : 'text-slate-300 hover:bg-[#1E293B] hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-sm font-semibold transition-all ${
              activeModule === 'proposals' ? 'bg-[#4F46E5] text-white' : 'text-slate-300 hover:bg-[#1E293B] hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-sm font-semibold transition-all ${
              activeModule === 'new-request' ? 'bg-[#4F46E5] text-white' : 'text-slate-300 hover:bg-[#1E293B] hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-sm font-semibold transition-all ${
              activeModule === 'variance' ? 'bg-[#4F46E5] text-white' : 'text-slate-300 hover:bg-[#1E293B] hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-sm font-semibold transition-all ${
              activeModule === 'scenarios' ? 'bg-[#4F46E5] text-white' : 'text-slate-300 hover:bg-[#1E293B] hover:text-white'
            }`}
          >
